...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .profile-pic { width: 150px; height: 150px; border-radius: 50%; object-fit: cover; border: 4px solid #e94560; margin-bottom: 20px; box-shadow: 0 0 20px rgba(233,69,96,0.5); cursor: pointer; transition: transform 0.3s; }
    ...
    .lightbox img { max-width: 90%; max-height: 90%; border-radius: 50%; border: 5px solid #e94560; box-shadow: 0 0 40px rgba(233,69,96,0.8); }
    .lightbox .close { position: absolute; top: 20px; right: 30px; color: white; font-size: 2.5em; cursor: pointer; font-weight: bold; }
...
<body>
  ...
  <div class="lightbox" id="lightbox" onclick="closeLightbox()">
    ...
    <img src="{% static 'images/pavel.jpg' %}" alt="Pavel Rahman">
  </div>

  <header>
    <img src="{% static 'images/pavel.jpg' %}" alt="Pavel Rahman" class="profile-pic" onclick="openLightbox()">
    <h1>Hi, I'm {{ name }} 👋</h1>
